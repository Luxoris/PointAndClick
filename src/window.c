...
void initFenetre(SDL_Window** pFenetre, const char cTitre[]){
    ...
    *(pFenetre) = SDL_CreateWindow(cTitre , SDL_WINDOWPOS_CENTERED , SDL_WINDOWPOS_CENTERED , WINDOW_LARGEUR , WINDOW_HAUTEUR, SDL_WINDOW_MOUSE_CAPTURE||SDL_WINDOW_RESIZABLE);
