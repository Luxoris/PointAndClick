...
//###########################################
//PROCEDURE dessineBalle
//*****************************************************************************************************//
//
// DESCRIPTION Dessine la balle, un booleen indique si la balle est pleine ou vide.
//
// ENTREE La référence du renderer, de la balle, le booleen
//
// SORTIE L'affichage de la balle
//
// NOTE -
//*****************************************************************************************************//
void dessineBalle(SDL_Renderer *pRenderer,tBalle *pstBalle, tBool bBallePleine){
    tCercle stCercle = getBalleCercle(pstBalle);
    SDL_Point stSDLPoint = convertionPointVersSDL_Point(getCerclePointCentral(&stCercle));
    if(bBallePleine){
        dessineCerclePlein(pRenderer,stSDLPoint,getCercleRayon(&stCercle));
    }else{
        dessineCercle(pRenderer,stSDLPoint,getCercleRayon(&stCercle));
    }
...
// NOTE -
//*****************************************************************************************************//
void dessineBouton(SDL_Renderer *pRenderer,tBouton *pstBouton, tPropTexte *pstPropTexte){
    ...
    if(!getBoutonSurvole(pstBouton)){
        ecrireChaine(pRenderer,getBoutonTexte(pstBouton),getBoutonObjet(pstBouton),pstPropTexte);   //affiche le texte
    }else{
        setPropTexte(&stPropTexteSurvol,getPropTexteTaille(pstPropTexte),getPropTexteEmplpolice(pstPropTexte),*getPropTexteCouleurAPlan(pstPropTexte),*getPropTexteCouleur(pstPropTexte),getPropTexteStyle(pstPropTexte),getPropTexteCharset(pstPropTexte),getPropTexteMode(pstPropTexte));
